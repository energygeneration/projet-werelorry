...
<div class="container-fluid">
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-color sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link text-white" href="/ajout.html">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
      ...
      <canvas class="my-4 w-100 chartjs-render-monitor" id="myChart" width="2244" height="946" style="display: block; height: 473px; width: 1122px;"></canvas>
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{ __('bienvenu sur votre interface') }}
                </div>
            </div>
        </div>
    </div>
...
<header class="navbar navbar-dark sticky-top bg-color flex-md-nowrap p-0 shadow">
  ...
  <input class="form-control form-control-dark w-90 rounded-0 border-0" type="text" placeholder="Search" aria-label="Search">
  <div class="navbar-nav">
                ...
                <div class="row">
                    ...
                    <div class="position-sticky pt-3 sidebar-sticky">
                        <ul class="nav flex-column ">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white" href="{{route('ajout')}}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shopping-cart align-text-bottom" aria-hidden="true"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>
                                Gestion des trajets
                                </a>
                            </li>
